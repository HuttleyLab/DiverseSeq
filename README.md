...
You can read more about the methods implemented in `diverse-seq` in the paper [here](https://joss.theoj.org/papers/10.21105/joss.07765).
...
`diverse-seq` is released under the BSD-3 license. If you want to contribute to the `diverse-seq` project (and we hope you do! 😇) the code of conduct and other useful developer information is available on the [wiki](https://github.com/HuttleyLab/DiverseSeq/wiki).